...
$(document).ready(function(){
    ...
    function myWeatherInterpretation(){
        ...
        $("#nycurrent").append('W/ ' + weathertext);
        $("#nycurrent1").append(humidity + "%");
...
$(document).ready(function(){
    ...
    function myWeatherInterpretation(){
        ...
        //JUST SEEING IF THE VALUES COME THROUGH
        $('#bacurrent').append('W/ ' + weathertext);
        $('#bacurrent1').append(humidity + "%");
...
$(document).ready(function(){
    ...
    function myWeatherInterpretation(){
        ...
        //JUST SEEING IF THE VALUES COME THROUGH
        $('#lacurrent').append('W/ ' + weathertext);
        $('#lacurrent1').append(humidity + "%");
...
$(document).ready(function(){
    ...
    function myWeatherInterpretation(){
        ...
        //JUST SEEING IF THE VALUES COME THROUGH
        $('#hocurrent').append('W/ ' + weathertext);
        $('#hocurrent1').append(humidity + "%");
